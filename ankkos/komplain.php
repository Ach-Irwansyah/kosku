            ...
            <div class="content-panel">
              ...
              <section id="no-more-tables">
                <table class="table table-bordered table-striped table-condensed cf">
                  ...
                  session_start();
                  $aa=$_SESSION['idu'];
                  $qry=mysql_query("select komplain.id_komplain,komplain.tgl_komplain,komplain.isi,user.nama from komplain,user where komplain.id_user=user.id_user and komplain.id_user='$aa'");
